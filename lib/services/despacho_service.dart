...
import '../widgets/modals/checklist_modal.dart';
import '../services/local_db_service.dart';
import '../services/print_service.dart';
import '../core/keys.dart';

class DespachoService {
  static final DespachoService _instance = DespachoService._();
  factory DespachoService() => _instance;
  DespachoService._();
  ...
  Future<void> abrirPicking(BuildContext context, Venta venta, {bool isReprint = false}) async {
    await showModalBottomSheet(
      ...
      builder: (ctx) => ChecklistModal(
        venta: venta,
        onFinish: (reimprimir) async {
          // 1. Marcar como despachado en DB Local
          if (venta.dbId != null) {
            await LocalDbService.marcarDespachado(venta.dbId!);
          }
