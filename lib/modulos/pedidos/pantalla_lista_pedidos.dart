...
class _EncabezadoResumenPedidos extends StatelessWidget {
  final int total;
  ...
  const _EncabezadoResumenPedidos({
    required this.total,
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed:
                      _orden.fotosUrls.isNotEmpty ? _imprimirLista : null,
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: _orden.fotosUrls.isNotEmpty
          ...
          Row(
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: _capturarYSubirFoto,
                  icon: const Icon(Icons.camera_alt_outlined),
                  label: const Text('Foto de lista'),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: _marcarPorCobrar,
