...
class IndicadorEstadoImpresora extends StatefulWidget {
  const IndicadorEstadoImpresora({super.key});
  factory IndicadorEstadoImpresora.custom() => const IndicadorEstadoImpresora();

  @override
  State<IndicadorEstadoImpresora> createState() => _IndicadorEstadoImpresoraState();
}
