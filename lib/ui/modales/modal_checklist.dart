...
class ModalListaChequeo extends StatefulWidget {
  final Venta venta;
  ...
  @override
  State<ModalListaChequeo> createState() => _ModalListaChequeoState();
}

class _ModalListaChequeoState extends State<ModalListaChequeo> {
