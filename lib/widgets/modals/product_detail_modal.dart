...
import 'package:bipenc/widgets/common/robust_image.dart';
import 'package:bipenc/services/label_pdf_service.dart';
...
class ProductDetailModal extends StatelessWidget {
  ...
  Presentacion _findPresentation(
    ...
    try {
      ...
      return Presentacion(
        ...
        name: fallbackName,
        conversionFactor: 1,
        prices: [PricePoint(type: 'NORMAL', amount: fallbackPrice)],
      );
    }
  }
  ...
  Future<void> _imprimirEtiqueta(BuildContext context) async {
    ...
    final pdf = await LabelPdfService.generateEtiquetasPdf(etiquetas);
    await LabelPdfService.share(pdf);
    if (context.mounted) {
