...
import 'package:bipenc/servicios/servicio_sincronizacion.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  group('ServicioSincronizacion', () {
    late ServicioSincronizacion service;
    ...
    setUp(() {
      ...
      service.internetCheckOverride = () async => true;
    });
    ...
    test('successful cycle runs all operations', () async {
      ...
      service.procesarColaImpresionOverride = () async => printRuns++;
    ...
    test('retry eventually succeeds', () async {
      ...
      service.procesarColaImpresionOverride = () async {};
