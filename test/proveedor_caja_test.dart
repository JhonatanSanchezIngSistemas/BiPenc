...
void main() {
  ...
  group('ProveedorCaja Logic Tests', () {
      ...
      prodTest = Producto(
        ...
        presentaciones: [
          Presentacion(
            ...
            name: 'Unidad',
            conversionFactor: 1,
            prices: [PuntoPrecio(type: 'NORMAL', amount: 10.0)],
          ),
          Presentacion(
            id: 'mayo',
            ...
            name: 'Mayorista',
            conversionFactor: 1,
            prices: [PuntoPrecio(type: 'WHOLESALE', amount: 8.0)],
          ),
        ],
        precioPropuesto: 8.0,
      );
    ...
    test('mapRowsToVentas transforma filas SQLite a modelo de tickets', () {
      ...
      final tickets = ProveedorCaja.mapRowsToVentas(rows, ivaRate: 0.18);
