...
void main() {
  group('ServicioImpresion formato ticket', () {
    test('formatea fecha como dd/MM/yyyy HH:mm', () {
      final formatted = ServicioImpresion.formatFechaTicket(
    ...
    test('preview incluye correlativo, cliente, totales y QR', () {
      final producto = Producto(
        ...
        presentaciones: [
          Presentacion(
            ...
            name: 'Unidad',
            conversionFactor: 1,
            prices: [PuntoPrecio(type: 'NORMAL', amount: 5.00)],
          ),
        ],
      );
      ...
      final preview = ServicioImpresion.buildTicketPreview(
        items: [item],
        total: 10.00,
        subtotalSinIgv: 8.47,
        igvValue: 1.53,
    ...
    test('layout de item no desborda en 80mm', () {
      final lines = ServicioImpresion.buildItemPreviewLines(
        nombre:
    ...
    test('wrap para ticket respeta ancho máximo', () {
      final wrapped = ServicioImpresion.wrapForTicket(
