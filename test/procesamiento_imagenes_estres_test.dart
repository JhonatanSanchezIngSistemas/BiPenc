...
void main() {
  ...
  final service = ServicioProcesamientoImagen();
  ...
  group('Pruebas Exhaustivas de IA Visual (Recorte de Fondo)', () {
    ...
    test('Debe detectar fondo dominante y eliminarlo (Escenario de contraste alto)', () async {
      ...
      // 4. Verificar borde (Debe ser blanco tras limpiar fondo)
      final corner = resultImg.getPixel(2, 2);
      expect(corner.r, greaterThanOrEqualTo(240));
      expect(corner.g, greaterThanOrEqualTo(240));
      expect(corner.b, greaterThanOrEqualTo(240));
    ...
    test('Debe manejar ruido en el fondo (Tolerancia)', () async {
      ...
      // El borde ruidoso debe desaparecer (transparente) con tolerancia alta.
